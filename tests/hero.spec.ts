...
import { Shield } from "../src/melee/shield";
...
//         setUp: function () {
//             return {
//                 hero: new Hero("Joe", 12, 12, Weapon.Weapon.NONE, Armor.Armor.NO_ARMOR, Shield.Shield.NO_SHIELD),
//                 heroBroadswordLeather: new Hero("Joe BS Leather", 12, 12, Weapon.BROADSWORD, Armor.LEATHER, Shield.Shield.NO_SHIELD),
//                 heroLeather: new Hero("JoeLeather", 12, 12, Weapon.Weapon.NONE, Armor.LEATHER, Shield.Shield.NO_SHIELD),
//                 heroOdd: new Hero("JoeOdd", 1, 2, Weapon.Weapon.NONE, Armor.Armor.NO_ARMOR, Shield.Shield.NO_SHIELD),
//             }
//         },
...
//             assert(o.heroOdd.getWeapon()).equals(Weapon.Weapon.NONE);
//         },
//         getReadiedWeapon: function (o) {
//             assert(o.heroBroadswordLeather.getReadiedWeapon()).equals(Weapon.BROADSWORD);
//             assert(o.heroOdd.getReadiedWeapon()).equals(Weapon.Weapon.NONE);
//         },
//         getArmor: function (o) {
//             assert(o.heroOdd.getArmor()).equals(Armor.Armor.NO_ARMOR);
//         },
//         getShield: function (o) {
//             assert(o.heroOdd.getShield()).equals(Shield.Shield.NO_SHIELD);
//         },
...
//             let heroNew = new Hero("Fred", 12, 12, Weapon.BROADSWORD, Armor.Armor.NO_ARMOR, Shield.Shield.NO_SHIELD);
...
//         //     assert(o.hero.getArmor()).equals(Armor.Armor.NO_ARMOR);
//         //     o.hero.setArmor(Armor.LEATHER);
//         //     assert(o.hero.getArmor()).equals(Armor.LEATHER);
//         // },
//         dropWeapon: function (o) {
//             o.heroBroadswordLeather.dropWeapon();
//             assert(o.heroBroadswordLeather.getReadiedWeapon()).equals(Weapon.Weapon.NONE);
...
//             assert(o.heroBroadswordLeather.getReadiedWeapon()).equals(Weapon.Weapon.NONE);
//             assert(o.heroBroadswordLeather.getDroppedWeapon()).equals(Weapon.Weapon.NONE);
//         },
...
//             hero.dropWeapon();
//             assert(hero.getReadiedWeapon()).equals(Weapon.Weapon.NONE);
//             hero.newRound();
//             assert(hero.getReadiedWeapon()).equals(Weapon.Weapon.NONE);
//             hero.pickUpWeapon();
//             assert(hero.getReadiedWeapon()).equals(Weapon.Weapon.NONE);
